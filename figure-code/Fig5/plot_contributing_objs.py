...
sol_num_selected = 2  # 0: Durham-focused, 1: Raleigh-focused, 2: Regionally-robust
window_size = 52
...
for i in range(len(sol_num)):
       ...
       fig_name = f'sol{sol_num[sol_num_selected]}_driving_objs.pdf'
