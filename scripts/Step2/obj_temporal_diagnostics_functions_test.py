...
def calculate_sol_reliability(util_num, window_size, sol_num, RDM, skip_weeks = 1):
    ...
    # Load the HDF5 file
    hdf5_file = pd.HDFStore(f'../Step1/sol{sol_num}_hdf_packed/Utilities_s{sol_num}_RDM{RDM}.h5', 'r')
...
def calculate_restriction_frequency(util_num, window_size, sol_num, RDM, skip_weeks=1):
    ...
    # Load the HDF5 file
    hdf5_file = pd.HDFStore(f'../Step1/sol{sol_num}_hdf_packed/Policies_s{sol_num}_RDM{RDM}.h5', 'r')
